...
- [x] Vercel 프리뷰 (새로고침 포함) — `feat-ssh-553` 프리뷰에서 헤더·배지 확인, 새로고침 뒤에도 유지(2026-09-12)
- [x] 스크린샷 S1 1440 · 768 · 390(첫 진입 모습 — 헤더에 배지 없음) + 1440 드래그 강조 상태 1장 → `docs/spec/SSH-553/apply-s1-*.png`
- [x] Figma 시안 5절 — 2026-09-12 4개 섹션(데스크톱·모바일·반응형 데모·예외 상태) 동기화, 렌더 확인(데스크톱 S1·S3·S5-a, 모바일 S3·S5-a)
