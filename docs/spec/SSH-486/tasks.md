...
- [ ] Figma S5-a 데스크톱·모바일을 팝업으로 다시 그리기 — 웹 화면 확인 뒤

## 10. 마무리

- [x] PR 본문 갱신(`/pr`) → `/pr-review` **별도 서브에이전트** → P1·P2 반영, P3 이하 보고 (2026-09-10 리뷰 1회: P1 없음 · P2 1건 반영 6c57d0e — 전송 중 「← 이전」·프로그레스 잠금 · P3 2건: 멱등 키는 SSH-544 코멘트로, 스크린샷 폭 보강은 보류 · P4 1건 PR 본문에 기록. 재리뷰 등록은 사람 확인 뒤)
