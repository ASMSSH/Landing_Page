...
- [x] PR 본문 갱신(`/pr`) → `/pr-review` 별도 서브에이전트 → 1회 등록(P1·P2 없음, P3 2건: ≤480 바 두 줄 꺾임 시 예약 높이 어긋남 · 데스크톱 오류 칸 focus 시 sticky 행이 덮음). 사용자 지시로 P3 2건 반영(3da1d7f 실측 바 높이 · 6603c96 데스크톱 scroll-padding), 스레드 답글·PR 본문 갱신. 재리뷰 등록은 사람 확인 뒤
