...
import { SUBSCRIBE_ERROR_MESSAGES } from "../lib/errorMessages";
          ...
          <div className="foot-btns">
            ...
            {step === 4 && (
              <button
                ...
                disabled={!agreed || !verifiedToken || subscribeStatus === "submitting" || subscribeStatus === "done"}
              >
